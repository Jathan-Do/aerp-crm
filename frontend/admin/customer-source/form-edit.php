        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control shadow-sm" id="source_key" name="source_key" value="<?php echo esc_attr($editing->source_key); ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea class="form-control shadow-sm" id="description" name="description" rows="3"><?php echo esc_textarea($editing->description); ?></textarea>
                </div>
            </div>
